...
st.markdown("<h2 style='text-align: center; color: #c0c0c0;'>Elecciones</h2>", unsafe_allow_html=True)
st.markdown(
    """
...
st.markdown("<h2 style='text-align: center; color: #c0c0c0;'>Resultados</h2>", unsafe_allow_html=True)
st.markdown(
    """
    <div style='text-align: center; padding-top: 20px;'>
        <p style='font-size: 1.1em; color: #b0b0b0;'>
...
st.markdown("<h2 style='text-align: center; color: #c0c0c0;'>Redes Sociales</h2>", unsafe_allow_html=True)
st.markdown(
    """
    <div style='text-align: center; padding-top: 20px;'>
        <p style='font-size: 1.1em; color: #b0b0b0;'>
